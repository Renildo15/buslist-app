...
export default function ModalNotice({notice, modalVisible, setModalVisible}: IModalNoticeProps) {
        ...
        <View style={styles.centeredView}>
            <View style={styles.modalView}>
                ...
                <View style={{width:'100%', marginTop:70}}>
                    ...
                    >
                        {notice && !notice.viewed ? <Text style={styles.textStyle}>OK</Text> : <Text style={styles.textStyle}>Fechar</Text>}
                    </Pressable>
                 </View>
            </View>
        </View>
