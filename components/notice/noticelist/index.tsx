...
import { FlatList, ListRenderItem, RefreshControl, SectionListData } from 'react-native';
...
export default function NoticeList() {
  ...
  } = useNotices(session ?? null, selectedFilter);
    ...
    <GestureHandlerRootView style={styles.container}>
      <View style={styles.header_list}>
        ...
        <View style={{ flexDirection: "row", gap: 4 }}>
          <ButtonIcon name="search" size={24} onPress={() => {}} />
