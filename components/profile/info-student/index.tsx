    ...
    <View style={styles.container}>
      ...
      <View>
        <View style={styles.avatar_container}>
          <TouchableOpacity style={styles.camera_icon} onPress={handleSelectImage}>
            <Avatar height={70} width={70} borderRadius={50} uri={avatarUri ?? ''} />
            <Feather name="camera" size={20} color="#007bff" style={styles.camera_icon_position} />
          </TouchableOpacity>
      ...
      {showButtonAvatar && <ButtonAvatarSave onPress={handleUploadAvatar} isLoading={isLoading} />}
    </View>
  );
}